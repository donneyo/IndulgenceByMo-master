...
const Product = ({ bread }) => {
  ...
  const handleClick = () => {
    dispatch(addProduct({ ...bread, extras, price, quantity }));
  };
    ...
    <div className={styles.container}>
      <div className={styles.left}>
        <div className={styles.imgContainer}>
          <Image src={bread.img} objectFit="contain" layout="fill" alt="" />
        </div>
      </div>
...
export const getServerSideProps = async ({ params }) => {
  const res = await axios.get(`${baseUrl}/api/products/${params.id}`); // ✅ use baseUrl
  return {
    props: {
      bread: res.data,
    },
